...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "_posts_v" (
  	...
  	"version_toc_depth" numeric DEFAULT 3,
  ...
  ALTER TABLE "posts" ADD CONSTRAINT "posts_thumb_id_media_id_fk" FOREIGN KEY ("thumb_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_posts_v" ADD CONSTRAINT "_posts_v_version_thumb_id_media_id_fk" FOREIGN KEY ("version_thumb_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "authors" ADD CONSTRAINT "authors_author_image_url_id_media_id_fk" FOREIGN KEY ("author_image_url_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  CREATE INDEX "users_roles_order_idx" ON "users_roles" USING btree ("order");
  CREATE INDEX "users_roles_parent_idx" ON "users_roles" USING btree ("parent_id");
  CREATE INDEX "posts_title_idx" ON "posts" USING btree ("title");
  CREATE INDEX "posts_slug_idx" ON "posts" USING btree ("slug");
  CREATE INDEX "posts_thumb_idx" ON "posts" USING btree ("thumb_id");
  ...
  CREATE INDEX "_posts_v_version_version_thumb_idx" ON "_posts_v" USING btree ("version_thumb_id");
  ...
  CREATE INDEX "authors_author_image_url_idx" ON "authors" USING btree ("author_image_url_id");
